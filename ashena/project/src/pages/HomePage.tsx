        ...
        <div className="relative max-w-5xl mx-auto grid lg:grid-cols-[1.2fr_0.8fr] gap-8 items-center">
          <div>
            ...
            <p className="text-lg text-slate-600 leading-8 mb-4 max-w-2xl">
              آشنا، ایرانی‌هایی را که مهاجرت را تجربه کرده‌اند به کسانی متصل می‌کند که برای تصمیم‌های مهم مهاجرت، به تجربه افرادی که این مسیر را پیموده‌اند تکیه می‌کنند.
            </p>
